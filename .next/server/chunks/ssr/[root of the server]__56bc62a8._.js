...
function TranslatorPage() {
    ...
    const [audioUrl, setAudioUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // to store the synthesized audio URL
    ...
    const handleAudioData = async ()=>{
        ...
        try {
            ...
            // Post the base64 audio along with the destination language to your transcription backend
    ...
    const postAudio = async (audioBase64)=>{
        ...
        try {
            ...
            // Assuming the response contains inputText and destinationTranscript/translatedText
    ...
    const playVoiceResponse = async (text)=>{
        ...
        try {
            ...
            // Check if blob size is non-zero and the type is valid
            ...
            // Create an Audio element and play immediately.
            ...
            console.error(err);
            setError("Error during voice playback.");
            setIsPlaying(false);
        }
    };
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: isPlaying ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    ...
                                                    className: `bg-[#7D9D9C] hover:bg-[#576F72] text-white px-4 py-2 rounded-md flex items-center justify-center mx-auto ${isTranslating || isRecording || !translatedText || isPlaying ? "opacity-50 cursor-not-allowed" : ""}`,
                                                    children: [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__56bc62a8._.js.map